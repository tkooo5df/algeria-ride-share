      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-lg font-bold text-primary">{reservation.price} DA</div>
            <div className="text-xs text-muted-foreground">{reservation.paymentMethod}</div>
          </div>
        </div>
      </CardHeader>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-sm">{reservation.driver.rating}</span>
                </div>
              </div>
            </div>
            <div className="text-right">
