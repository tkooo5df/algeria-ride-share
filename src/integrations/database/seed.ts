...
export const seedDatabase = async () => {
  ...
  if (typeof window !== 'undefined') {
    console.log('🌱 Skipping database seeding in browser environment');
    return;
  }
  ...
  try {
    ...
    const notifications = [
      ...
      },
      {
        ...
        title: 'رحلة مكتملة',
        message: 'شكراً لك على استخدام DZ Taxi. نتمنى لك رحلة سعيدة!',
        type: 'success',
    ...
    console.log('  - 4 driver profiles');
    console.log('  - 5 passenger profiles');
    console.log('  - 4 vehicles (Renault, Peugeot, Hyundai, Dacia)');
    console.log('  - 8 realistic trips across Algeria');
    console.log('  - 5 detailed bookings with real locations');
    console.log('  - 8 notifications');
    console.log('  - System settings');
    console.log('');
    console.log('🚗 Realistic data includes:');
    console.log('  - Trips between major cities (Algiers, Oran, Constantine, Annaba)');
    console.log('  - Real Algerian addresses and phone numbers');
    console.log('  - Different payment methods (COD, BaridiMob)');
    console.log('  - Various vehicle types and years');
    console.log('  - Detailed booking information with special requests');
